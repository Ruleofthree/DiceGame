'''
A script to determine damage done, if the player was successfully hit
'''
import random
...
while answer == "y":
    ...
    # and maximum possible damage. Example: Level 5 is 45hp, minimum damage is 1, and maximum damage is 10
    levelDict = {1: [25, 1, 6],
                 2: [30, 1, 6],
                 3: [35, 1, 8],
                 4: [40, 1, 8],
    ...
    # This entire if statement determins if Player 1 is the victor. If he was, print out his remaining HP.
    ...
    if levelOneCurrentHP > 0:
        ...
        # This is to keep low level players from trying to fight high level players to try and 'get luck' and earn
