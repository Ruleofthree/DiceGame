...
#     xp = int((level * (level - 1) * 75) / 2)
#     print("Level " + str(level - 1) + ": " + str(xp))
...
levelDict =         {1: [ 25,  1,   6,   15,   2,  1,  5,    75],
                     2: [ 30,  1,   6,   15,   2,  2,  6,   220],
                     3: [ 35,  1,   8,   15,   3,  2,  7,   450],
                     4: [ 40,  1,   8,   15,   3,  3,  8,   750],
                     5: [ 45,  1,  10,   16,   4,  3,  9,  1125],
                     6: [ 50,  1,  10,   16,   4,  4, 10,  1575],
                     7: [ 55,  2,  12,   16,   5,  4, 11,  2100],
                     8: [ 60,  2,  12,   16,   5,  5, 12,  2700],
                     9: [ 65,  2,  16,   16,   6,  5, 13,  3375],
                    10: [ 70,  2,  16,   17,   6,  6, 15,  4125],
                    11: [ 75,  3,  18,   17,   7,  6, 16,  4950],
                    12: [ 80,  3,  18,   17,   7,  7, 17,  5850],
                    13: [ 85,  2,  20,   17,   8,  7, 18,  6825],
                    14: [ 90,  2,  20,   17,   8,  8, 19,  7875],
                    15: [100,  2,  24,   18,   9,  8, 20,  9000],
                    16: [110,  4,  24,   18,   9,  9, 21, 10200],
                    17: [130,  4,  32,   18,  10,  9, 22, 11475],
                    18: [135,  4,  32,   18,  10, 10, 23, 12825],
                    19: [140,  3,  36,   18,  11, 10, 24, 14250],
                    20: [150,  3,  36,   19,  11, 11, 25, 15750]}

file = open("levelchart.txt", "w", encoding="utf-8")
json.dump(levelDict, file, ensure_ascii=False, indent=2)
